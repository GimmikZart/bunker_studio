...
- Test mirati post-hardening: Lead workflow plan 2/2, AgentRuntime 6/6, Anthropic adapter 2/2, Git 7/7, Notifications 4/4, Worker 10/10, Web routes 33/33 (inclusi archivio conversazioni, budget/design/task gates), DB worker scheduler 3/3, typecheck 15/15: PASS.
